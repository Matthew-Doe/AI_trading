...
- [[.cancel_order_by_id()]] - `method` [EXTRACTED]
- [[.get_account()_1]] - `method` [EXTRACTED]
- [[.get_all_positions()_1]] - `method` [EXTRACTED]
- [[.get_orders()]] - `method` [EXTRACTED]
...
- [[test_buy_more_signal_uses_cash_rich_cap_when_available_cash_is_high()]] - `calls` [EXTRACTED]
- [[test_daily_loss_kill_switch_blocks_new_orders()]] - `calls` [EXTRACTED]
- [[test_evaluate_held_positions_avoids_selling_long_at_loss()]] - `calls` [EXTRACTED]
- [[test_evaluate_held_positions_returns_three_signal_types()]] - `calls` [EXTRACTED]
...
- [[test_live_paper_backtest_style_refuses_non_paper_url()]] - `calls` [EXTRACTED]
- [[test_live_paper_backtest_style_requires_empty_account_and_bias_readiness()]] - `calls` [EXTRACTED]
